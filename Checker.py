...
class twitch:
    ...
    def update_title(self):
        ...
        ctypes.windll.kernel32.SetConsoleTitleW(
            f"Lag Checker | Available: {self.available} | Unavailable: {self.unavailable} | Checked: {(self.available + self.unavailable)} | Remaining: {remaining}"
        )
    ...
    def check_username(self, username):
        ...
        with requests.Session() as session:
            ...
            r = session.head("https://m.twitch.tv/{}".format(username), headers = headers)
